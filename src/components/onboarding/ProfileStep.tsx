          ...
          return (
            <div className="space-y-4">
              <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
                <p className="text-muted-foreground mb-4">Upload a profile picture</p>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <div className="border-2 border-dashed border-border rounded-lg p-6 text-center">
            <p className="text-muted-foreground mb-3">Upload a profile picture</p>
            <Button variant="outline" className="transition-spring">
              Choose Photo
            </Button>
          </div>
          ...
          <div className="space-y-3">
            <div className="relative">
              ...
              <Input
                ...
                className="transition-spring pl-10"
              />
            </div>
            <div className="relative">
              <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="relative">
              ...
              <Input
                placeholder="LinkedIn profile"
                value={localData.socialMedia.linkedin || ''}
                onChange={(e) => setLocalData(prev => ({
                  ...prev,
                  socialMedia: { ...prev.socialMedia, linkedin: e.target.value }
                }))}
            ...
            <div className="relative">
              ...
              <Input
                placeholder="YouTube channel"
                value={localData.socialMedia.youtube || ''}
                onChange={(e) => setLocalData(prev => ({
                  ...prev,
                  socialMedia: { ...prev.socialMedia, youtube: e.target.value }
                }))}
            ...
            <div className="relative">
              ...
              <Input
                placeholder="TikTok username"
                value={localData.socialMedia.tiktok || ''}
                onChange={(e) => setLocalData(prev => ({
                  ...prev,
                  socialMedia: { ...prev.socialMedia, tiktok: e.target.value }
                }))}
