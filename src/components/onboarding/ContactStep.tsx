...
export function ContactStep({ data, updateData, onNext, onPrev }: ContactStepProps) {
  const [localData, setLocalData] = useState(data.socialMedia);

  const handleNext = () => {
    updateData({ socialMedia: localData });
    onNext();
  };
  ...
  return (
    <Card className="glass shadow-apple-lg">
      <CardHeader>
        <CardTitle className="text-2xl font-medium">Connect your social media</CardTitle>
        <p className="text-muted-foreground">
          These will not be accessible to other users until you connect (Optional)
        </p>
      </CardHeader>
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) => setLocalData(prev => ({ ...prev, linkedin: e.target.value }))}
              className="pl-10"
            />
          </div>
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) => setLocalData(prev => ({ ...prev, youtube: e.target.value }))}
              className="pl-10"
            />
          </div>
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) => setLocalData(prev => ({ ...prev, tiktok: e.target.value }))}
              className="pl-10"
            />
          </div>
        </div>
